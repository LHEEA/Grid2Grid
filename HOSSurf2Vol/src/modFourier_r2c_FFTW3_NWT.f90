...
SELECT CASE (lib)
   CASE (3)
      ...
      IF (n2 == 1) THEN
         ! 1D FFTs
         CALL dfftw_plan_r2r_1d(plan_CC, n1,   in(1,1),     out(1,1),     FFTW_REDFT00, flag)
         CALL dfftw_plan_r2r_1d(plan_SC, n1-2, in_sin(1,1), out_sin(1,1), FFTW_RODFT00, flag)
         !
         CALL dfftw_plan_r2r_1d(plan_CC_add,   n3_add, in_add(1,1), out_add(1,1), FFTW_REDFT01, flag)
         CALL dfftw_plan_r2r_1d(plan_CC_add_I, n3_add, in_add(1,1), out_add(1,1), FFTW_REDFT10, flag)
         CALL dfftw_plan_r2r_1d(plan_SC_add,   n3_add, in_add(1,1), out_add(1,1), FFTW_RODFT01, flag)
         CALL dfftw_plan_r2r_1d(plan_SC_add_I, n3_add, in_add(1,1), out_add(1,1), FFTW_RODFT10, flag)
	 	 !
         ! Fourier transforms on 'dealiased' domain i.e. extended
         IF (nd1 > 2) THEN
      ...
      ELSE
         ! 2D FFTs
         CALL dfftw_plan_r2r_2d(plan_CC, n1,   n2,   in(1,1),     out(1,1),     FFTW_REDFT00, FFTW_REDFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_SC, n1-2, n2,   in_sin(1,1), out_sin(1,1), FFTW_RODFT00, FFTW_REDFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_CS, n1,   n2-2, in(1,2),     out(1,2),     FFTW_REDFT00, FFTW_RODFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_SS, n1-2, n2-2, in_sin(1,2), out_sin(1,2), FFTW_RODFT00, FFTW_RODFT00, flag)
         ! 2D FFTs y-direction only
         CALL dfftw_plan_r2r_1d(plan_Cy, n2,   in_y(1), out_y(1), FFTW_REDFT00, flag)
         CALL dfftw_plan_r2r_1d(plan_Sy, n2-2, in_y(2), out_y(2), FFTW_RODFT00, flag)
         ! 2D FFTs additionnal potential
         CALL dfftw_plan_r2r_2d(plan_CC_add,   n3_add, n2,   in_add(1,1), out_add(1,1), FFTW_REDFT01, FFTW_REDFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_CC_add_I, n3_add, n2,   in_add(1,1), out_add(1,1), FFTW_REDFT10, FFTW_REDFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_SC_add,   n3_add, n2,   in_add(1,1), out_add(1,1), FFTW_RODFT01, FFTW_REDFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_SC_add_I, n3_add, n2,   in_add(1,1), out_add(1,1), FFTW_RODFT10, FFTW_REDFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_CS_add,   n3_add, n2-2, in_add(1,2), out_add(1,2), FFTW_REDFT01, FFTW_RODFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_CS_add_I, n3_add, n2-2, in_add(1,2), out_add(1,2), FFTW_REDFT10, FFTW_RODFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_SS_add,   n3_add, n2-2, in_add(1,2), out_add(1,2), FFTW_RODFT01, FFTW_RODFT00, flag)
         CALL dfftw_plan_r2r_2d(plan_SS_add_I, n3_add, n2-2, in_add(1,2), out_add(1,2), FFTW_RODFT10, FFTW_RODFT00, flag)
	 	 !
