...
USE modInput_post_process_NWT
USE modRead_files_NWT
USE modOutput_post_process_NWT
USE modReconstruction_NWT
...
IF (i_card /= 0) THEN
	...
	CLOSE(32)
ENDIF
END SUBROUTINE Post_processing_NWT 
!
! End of main program 
!
END MODULE modPost_processing_NWT